...
- filterByInUse() : `Channel[]`
- filterByNotInUse() : `Channel[]`
...
- filterByInUse() : `Message[]`
- filterByNotInUse() : `Message[]`
...
- filterByInUse() : `Operation[]`
- filterByNotInUse() : `Operation[]`
...
- filterByInUse() : `Schema[]`
- filterByNotInUse() : `Schema[]`
...
- filterByInUse() : `Server[]`
- filterByNotInUse() : `Server[]`
